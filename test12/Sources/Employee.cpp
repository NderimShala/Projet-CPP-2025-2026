...
ostream& operator<<(ostream& s, const Employee& p)
{
    s << "<Employee>" << endl;
    s << "<lastNamde>" << endl;
    s << p.getLastName() << endl;
    s << "</lastName>" << endl;
    s << "<firstName>" << endl;
    s << p.getFirstName() << endl;
    s << "</fistName>" << endl;
    s << "<id>" << endl;
    s << p.getId() << endl;
    s << "</id>" << endl;
...
istream& operator>>(istream& s, Employee& p)
{
    string lastNameTmp, firstNameTmp, Idtmp, loginTmp, roleTmp, tag;
    getline(s, tag);
    ...
    p.setLastName(lastNameTmp);
    p.setFirstName(firstNameTmp);
    p.setId(stoi(Idtmp));
    p.setLogin(loginTmp);
    p.setRole(roleTmp);
